...
//@interface k8_2_ResearchObject : NSObject
//@end

@interface k8_2_ResearchObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k8_2_ResearchObject class]])
		{
			for (NSString *key in [[(k8_2_ResearchObject*)o modules] allKeys])
			{
