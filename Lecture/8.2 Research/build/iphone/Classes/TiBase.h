...
// in simulator we redefine to format for k8_2_Research Developer console
...
{\
	NSString * exceptionName = [@"org.k8_2_research." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k8_2_research";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk8_2_ResearchNativeItemNone = -1, 
	UIk8_2_ResearchNativeItemSpinner = -2,
	UIk8_2_ResearchNativeItemProgressBar = -3,
	
	UIk8_2_ResearchNativeItemSlider = -4,
	UIk8_2_ResearchNativeItemSwitch = -5,
	UIk8_2_ResearchNativeItemMultiButton = -6,
	UIk8_2_ResearchNativeItemSegmented = -7,
	
	UIk8_2_ResearchNativeItemTextView = -8,
	UIk8_2_ResearchNativeItemTextField = -9,
	UIk8_2_ResearchNativeItemSearchBar = -10,
	
	UIk8_2_ResearchNativeItemPicker = -11,
	UIk8_2_ResearchNativeItemDatePicker = -12,
	
	UIk8_2_ResearchNativeItemInfoLight = -13,
	UIk8_2_ResearchNativeItemInfoDark = -14,
	
	UIk8_2_ResearchNativeItemDisclosure = -15,
	
	UIk8_2_ResearchNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k8_2_Research instances of
