...
//Rare exceptions to indicate a bug in the _k8_2_research code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k8_2_Research proxies.
 */
