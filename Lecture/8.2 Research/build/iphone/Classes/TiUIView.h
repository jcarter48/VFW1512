...
/**
 Base class for all k8_2_Research views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k8_2_Research view hierarchy (such as wrapped iOS UIViews) was touched.
