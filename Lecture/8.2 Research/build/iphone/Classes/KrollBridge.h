...
@interface k8_2_ResearchObject : KrollCoverageObject {
#else
@interface k8_2_ResearchObject : KrollObject {
#endif
@private
...
extern NSString * k8_2_Research$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k8_2_ResearchObject *_k8_2_research;
    KrollObject* console;
	BOOL shutdown;
