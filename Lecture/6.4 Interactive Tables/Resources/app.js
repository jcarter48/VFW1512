...
var getDetail = function(){
	var detailWin = Ti.UI.createWindow({
		...
		layout: "vertical",
		//little animation sliding up when opening window
		modal: true
	});
...
var list = [
	{title: "Potato Chips", color: "#fdf496", photo: "chips.png", desc: "I refuse to eat chips if anyone else sticks their hand in the bag.", status: "hasDetail"},
	{title: "Cheese", color: "#e1a72b", photo: "cheese.png", desc: "I dont like cheese on burgers."},
	{title: "Tomatoes", color: "#f28367", photo: "tomatoes.png", desc: "BLTs have tomatoes and BLTs are good.", status: "hasChild"},
	...
	{title: "Coconut Rum", color: "#9f7348", photo: "coconut rum.png", desc: "Something something underage drinking is bad.", status: "hasDetail"},
];
...
for(var i=0; i<list.length; i++){
	...
	if(list[i].status === "hasChild"){
		row.hasChild = true;
	}else if(list[i].status === "hasDetail"){
		row.hasDetail = true;
	}
