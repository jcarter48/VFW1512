...
@interface k6_4_Interactive_TablesObject : KrollCoverageObject {
#else
@interface k6_4_Interactive_TablesObject : KrollObject {
#endif
@private
...
extern NSString * k6_4_Interactive_Tables$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k6_4_Interactive_TablesObject *_k6_4_interactive_tables;
    KrollObject* console;
	BOOL shutdown;
