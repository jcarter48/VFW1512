...
// in simulator we redefine to format for k6_4_Interactive_Tables Developer console
...
{\
	NSString * exceptionName = [@"org.k6_4_interactive_tables." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k6_4_interactive_tables";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk6_4_Interactive_TablesNativeItemNone = -1, 
	UIk6_4_Interactive_TablesNativeItemSpinner = -2,
	UIk6_4_Interactive_TablesNativeItemProgressBar = -3,
	
	UIk6_4_Interactive_TablesNativeItemSlider = -4,
	UIk6_4_Interactive_TablesNativeItemSwitch = -5,
	UIk6_4_Interactive_TablesNativeItemMultiButton = -6,
	UIk6_4_Interactive_TablesNativeItemSegmented = -7,
	
	UIk6_4_Interactive_TablesNativeItemTextView = -8,
	UIk6_4_Interactive_TablesNativeItemTextField = -9,
	UIk6_4_Interactive_TablesNativeItemSearchBar = -10,
	
	UIk6_4_Interactive_TablesNativeItemPicker = -11,
	UIk6_4_Interactive_TablesNativeItemDatePicker = -12,
	
	UIk6_4_Interactive_TablesNativeItemInfoLight = -13,
	UIk6_4_Interactive_TablesNativeItemInfoDark = -14,
	
	UIk6_4_Interactive_TablesNativeItemDisclosure = -15,
	
	UIk6_4_Interactive_TablesNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k6_4_Interactive_Tables instances of
