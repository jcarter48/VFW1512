...
//Rare exceptions to indicate a bug in the _k6_4_interactive_tables code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k6_4_Interactive_Tables proxies.
 */
