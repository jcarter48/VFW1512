 ...
 * to send analytic data that can be viewed on the k6_4_Interactive_Tables Dashboard.
 *
 * For information on getting started with k6_4_Interactive_Tables Platform Services,
