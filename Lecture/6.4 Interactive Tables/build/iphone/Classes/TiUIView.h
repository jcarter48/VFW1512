...
/**
 Base class for all k6_4_Interactive_Tables views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k6_4_Interactive_Tables view hierarchy (such as wrapped iOS UIViews) was touched.
