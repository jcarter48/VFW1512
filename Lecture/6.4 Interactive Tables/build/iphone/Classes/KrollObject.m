...
//@interface k6_4_Interactive_TablesObject : NSObject
//@end

@interface k6_4_Interactive_TablesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k6_4_Interactive_TablesObject class]])
		{
			for (NSString *key in [[(k6_4_Interactive_TablesObject*)o modules] allKeys])
			{
