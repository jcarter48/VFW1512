...
//Rare exceptions to indicate a bug in the _carter_jacob_take_home_activity1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Carter_Jacob_Take_Home_Activity1 proxies.
 */
