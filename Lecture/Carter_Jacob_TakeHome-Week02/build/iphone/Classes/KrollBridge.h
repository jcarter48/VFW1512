...
@interface Carter_Jacob_Take_Home_Activity1Object : KrollCoverageObject {
#else
@interface Carter_Jacob_Take_Home_Activity1Object : KrollObject {
#endif
@private
...
extern NSString * Carter_Jacob_Take_Home_Activity1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Carter_Jacob_Take_Home_Activity1Object *_carter_jacob_take_home_activity1;
    KrollObject* console;
	BOOL shutdown;
