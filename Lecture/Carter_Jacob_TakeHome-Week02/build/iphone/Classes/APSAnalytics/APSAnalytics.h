 ...
 * to send analytic data that can be viewed on the Carter_Jacob_Take_Home_Activity1 Dashboard.
 *
 * For information on getting started with Carter_Jacob_Take_Home_Activity1 Platform Services,
