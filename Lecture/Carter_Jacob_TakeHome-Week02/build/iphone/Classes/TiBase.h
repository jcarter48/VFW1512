...
// in simulator we redefine to format for Carter_Jacob_Take_Home_Activity1 Developer console
...
{\
	NSString * exceptionName = [@"org.carter_jacob_take_home_activity1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.carter_jacob_take_home_activity1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICarter_Jacob_Take_Home_Activity1NativeItemNone = -1, 
	UICarter_Jacob_Take_Home_Activity1NativeItemSpinner = -2,
	UICarter_Jacob_Take_Home_Activity1NativeItemProgressBar = -3,
	
	UICarter_Jacob_Take_Home_Activity1NativeItemSlider = -4,
	UICarter_Jacob_Take_Home_Activity1NativeItemSwitch = -5,
	UICarter_Jacob_Take_Home_Activity1NativeItemMultiButton = -6,
	UICarter_Jacob_Take_Home_Activity1NativeItemSegmented = -7,
	
	UICarter_Jacob_Take_Home_Activity1NativeItemTextView = -8,
	UICarter_Jacob_Take_Home_Activity1NativeItemTextField = -9,
	UICarter_Jacob_Take_Home_Activity1NativeItemSearchBar = -10,
	
	UICarter_Jacob_Take_Home_Activity1NativeItemPicker = -11,
	UICarter_Jacob_Take_Home_Activity1NativeItemDatePicker = -12,
	
	UICarter_Jacob_Take_Home_Activity1NativeItemInfoLight = -13,
	UICarter_Jacob_Take_Home_Activity1NativeItemInfoDark = -14,
	
	UICarter_Jacob_Take_Home_Activity1NativeItemDisclosure = -15,
	
	UICarter_Jacob_Take_Home_Activity1NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Carter_Jacob_Take_Home_Activity1 instances of
