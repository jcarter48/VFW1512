...
/**
 Base class for all Carter_Jacob_Take_Home_Activity1 views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the Carter_Jacob_Take_Home_Activity1 view hierarchy (such as wrapped iOS UIViews) was touched.
