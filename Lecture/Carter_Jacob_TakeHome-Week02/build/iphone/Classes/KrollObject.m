...
//@interface Carter_Jacob_Take_Home_Activity1Object : NSObject
//@end

@interface Carter_Jacob_Take_Home_Activity1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Carter_Jacob_Take_Home_Activity1Object class]])
		{
			for (NSString *key in [[(Carter_Jacob_Take_Home_Activity1Object*)o modules] allKeys])
			{
