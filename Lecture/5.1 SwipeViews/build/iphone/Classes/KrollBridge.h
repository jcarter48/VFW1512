...
@interface k5_1_SwipeViewsObject : KrollCoverageObject {
#else
@interface k5_1_SwipeViewsObject : KrollObject {
#endif
@private
...
extern NSString * k5_1_SwipeViews$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k5_1_SwipeViewsObject *_k5_1_swipeviews;
    KrollObject* console;
	BOOL shutdown;
