...
/**
 The base class for all k5_1_SwipeViews modules
 */
...
/**
 k5_1_SwipeViews Platform calls this method on startup.
 */
-(void)startup;

/**
 k5_1_SwipeViews Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 k5_1_SwipeViews Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 k5_1_SwipeViews Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 k5_1_SwipeViews Platform calls this method on resume.
 @param sender The sender of the event.
 */
