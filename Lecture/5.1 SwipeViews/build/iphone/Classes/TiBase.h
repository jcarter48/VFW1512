...
// in simulator we redefine to format for k5_1_SwipeViews Developer console
...
{\
	NSString * exceptionName = [@"org.k5_1_swipeviews." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k5_1_swipeviews";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk5_1_SwipeViewsNativeItemNone = -1, 
	UIk5_1_SwipeViewsNativeItemSpinner = -2,
	UIk5_1_SwipeViewsNativeItemProgressBar = -3,
	
	UIk5_1_SwipeViewsNativeItemSlider = -4,
	UIk5_1_SwipeViewsNativeItemSwitch = -5,
	UIk5_1_SwipeViewsNativeItemMultiButton = -6,
	UIk5_1_SwipeViewsNativeItemSegmented = -7,
	
	UIk5_1_SwipeViewsNativeItemTextView = -8,
	UIk5_1_SwipeViewsNativeItemTextField = -9,
	UIk5_1_SwipeViewsNativeItemSearchBar = -10,
	
	UIk5_1_SwipeViewsNativeItemPicker = -11,
	UIk5_1_SwipeViewsNativeItemDatePicker = -12,
	
	UIk5_1_SwipeViewsNativeItemInfoLight = -13,
	UIk5_1_SwipeViewsNativeItemInfoDark = -14,
	
	UIk5_1_SwipeViewsNativeItemDisclosure = -15,
	
	UIk5_1_SwipeViewsNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k5_1_SwipeViews instances of
