...
//@interface k5_1_SwipeViewsObject : NSObject
//@end

@interface k5_1_SwipeViewsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k5_1_SwipeViewsObject class]])
		{
			for (NSString *key in [[(k5_1_SwipeViewsObject*)o modules] allKeys])
			{
