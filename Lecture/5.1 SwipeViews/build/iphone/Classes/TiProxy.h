...
//Rare exceptions to indicate a bug in the _k5_1_swipeviews code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k5_1_SwipeViews proxies.
 */
