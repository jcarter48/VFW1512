...
/**
 Base class for all k5_1_SwipeViews views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k5_1_SwipeViews view hierarchy (such as wrapped iOS UIViews) was touched.
