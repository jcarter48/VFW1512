...
//@interface k6_2_TableViewSectionsObject : NSObject
//@end

@interface k6_2_TableViewSectionsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k6_2_TableViewSectionsObject class]])
		{
			for (NSString *key in [[(k6_2_TableViewSectionsObject*)o modules] allKeys])
			{
