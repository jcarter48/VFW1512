 ...
 * to send analytic data that can be viewed on the k6_2_TableViewSections Dashboard.
 *
 * For information on getting started with k6_2_TableViewSections Platform Services,
