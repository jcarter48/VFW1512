...
/**
 The base class for all k6_2_TableViewSections modules
 */
...
/**
 k6_2_TableViewSections Platform calls this method on startup.
 */
-(void)startup;

/**
 k6_2_TableViewSections Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 k6_2_TableViewSections Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 k6_2_TableViewSections Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 k6_2_TableViewSections Platform calls this method on resume.
 @param sender The sender of the event.
 */
