...
/**
 Base class for all k6_2_TableViewSections views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k6_2_TableViewSections view hierarchy (such as wrapped iOS UIViews) was touched.
