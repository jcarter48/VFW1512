...
@interface k6_2_TableViewSectionsObject : KrollCoverageObject {
#else
@interface k6_2_TableViewSectionsObject : KrollObject {
#endif
@private
...
extern NSString * k6_2_TableViewSections$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k6_2_TableViewSectionsObject *_k6_2_tableviewsections;
    KrollObject* console;
	BOOL shutdown;
