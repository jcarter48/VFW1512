...
// in simulator we redefine to format for k6_2_TableViewSections Developer console
...
{\
	NSString * exceptionName = [@"org.k6_2_tableviewsections." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k6_2_tableviewsections";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk6_2_TableViewSectionsNativeItemNone = -1, 
	UIk6_2_TableViewSectionsNativeItemSpinner = -2,
	UIk6_2_TableViewSectionsNativeItemProgressBar = -3,
	
	UIk6_2_TableViewSectionsNativeItemSlider = -4,
	UIk6_2_TableViewSectionsNativeItemSwitch = -5,
	UIk6_2_TableViewSectionsNativeItemMultiButton = -6,
	UIk6_2_TableViewSectionsNativeItemSegmented = -7,
	
	UIk6_2_TableViewSectionsNativeItemTextView = -8,
	UIk6_2_TableViewSectionsNativeItemTextField = -9,
	UIk6_2_TableViewSectionsNativeItemSearchBar = -10,
	
	UIk6_2_TableViewSectionsNativeItemPicker = -11,
	UIk6_2_TableViewSectionsNativeItemDatePicker = -12,
	
	UIk6_2_TableViewSectionsNativeItemInfoLight = -13,
	UIk6_2_TableViewSectionsNativeItemInfoDark = -14,
	
	UIk6_2_TableViewSectionsNativeItemDisclosure = -15,
	
	UIk6_2_TableViewSectionsNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k6_2_TableViewSections instances of
