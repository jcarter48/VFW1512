...
//Rare exceptions to indicate a bug in the _k6_2_tableviewsections code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k6_2_TableViewSections proxies.
 */
