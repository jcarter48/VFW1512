...
//Rare exceptions to indicate a bug in the _k5_3_swipeviews_zoom code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k5_3_SwipeViews_Zoom proxies.
 */
