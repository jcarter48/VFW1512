...
/**
 Base class for all k5_3_SwipeViews_Zoom views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k5_3_SwipeViews_Zoom view hierarchy (such as wrapped iOS UIViews) was touched.
