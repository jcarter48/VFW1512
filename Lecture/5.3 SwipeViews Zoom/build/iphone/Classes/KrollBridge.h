...
@interface k5_3_SwipeViews_ZoomObject : KrollCoverageObject {
#else
@interface k5_3_SwipeViews_ZoomObject : KrollObject {
#endif
@private
...
extern NSString * k5_3_SwipeViews_Zoom$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k5_3_SwipeViews_ZoomObject *_k5_3_swipeviews_zoom;
    KrollObject* console;
	BOOL shutdown;
