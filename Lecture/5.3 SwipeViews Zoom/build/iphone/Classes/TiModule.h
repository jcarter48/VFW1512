...
/**
 The base class for all k5_3_SwipeViews_Zoom modules
 */
...
/**
 k5_3_SwipeViews_Zoom Platform calls this method on startup.
 */
-(void)startup;

/**
 k5_3_SwipeViews_Zoom Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 k5_3_SwipeViews_Zoom Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 k5_3_SwipeViews_Zoom Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 k5_3_SwipeViews_Zoom Platform calls this method on resume.
 @param sender The sender of the event.
 */
