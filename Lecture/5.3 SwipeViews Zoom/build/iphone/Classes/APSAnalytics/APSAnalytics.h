 ...
 * to send analytic data that can be viewed on the k5_3_SwipeViews_Zoom Dashboard.
 *
 * For information on getting started with k5_3_SwipeViews_Zoom Platform Services,
