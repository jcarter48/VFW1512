...
// in simulator we redefine to format for k5_3_SwipeViews_Zoom Developer console
...
{\
	NSString * exceptionName = [@"org.k5_3_swipeviews_zoom." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k5_3_swipeviews_zoom";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk5_3_SwipeViews_ZoomNativeItemNone = -1, 
	UIk5_3_SwipeViews_ZoomNativeItemSpinner = -2,
	UIk5_3_SwipeViews_ZoomNativeItemProgressBar = -3,
	
	UIk5_3_SwipeViews_ZoomNativeItemSlider = -4,
	UIk5_3_SwipeViews_ZoomNativeItemSwitch = -5,
	UIk5_3_SwipeViews_ZoomNativeItemMultiButton = -6,
	UIk5_3_SwipeViews_ZoomNativeItemSegmented = -7,
	
	UIk5_3_SwipeViews_ZoomNativeItemTextView = -8,
	UIk5_3_SwipeViews_ZoomNativeItemTextField = -9,
	UIk5_3_SwipeViews_ZoomNativeItemSearchBar = -10,
	
	UIk5_3_SwipeViews_ZoomNativeItemPicker = -11,
	UIk5_3_SwipeViews_ZoomNativeItemDatePicker = -12,
	
	UIk5_3_SwipeViews_ZoomNativeItemInfoLight = -13,
	UIk5_3_SwipeViews_ZoomNativeItemInfoDark = -14,
	
	UIk5_3_SwipeViews_ZoomNativeItemDisclosure = -15,
	
	UIk5_3_SwipeViews_ZoomNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k5_3_SwipeViews_Zoom instances of
