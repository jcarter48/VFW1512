...
//@interface k5_3_SwipeViews_ZoomObject : NSObject
//@end

@interface k5_3_SwipeViews_ZoomObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k5_3_SwipeViews_ZoomObject class]])
		{
			for (NSString *key in [[(k5_3_SwipeViews_ZoomObject*)o modules] allKeys])
			{
