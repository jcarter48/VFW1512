...
/**
 The base class for all k7_1_NavigationWindows modules
 */
...
/**
 k7_1_NavigationWindows Platform calls this method on startup.
 */
-(void)startup;

/**
 k7_1_NavigationWindows Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 k7_1_NavigationWindows Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 k7_1_NavigationWindows Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 k7_1_NavigationWindows Platform calls this method on resume.
 @param sender The sender of the event.
 */
