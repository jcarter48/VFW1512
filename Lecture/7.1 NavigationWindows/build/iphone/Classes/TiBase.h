...
// in simulator we redefine to format for k7_1_NavigationWindows Developer console
...
{\
	NSString * exceptionName = [@"org.k7_1_navigationwindows." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k7_1_navigationwindows";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk7_1_NavigationWindowsNativeItemNone = -1, 
	UIk7_1_NavigationWindowsNativeItemSpinner = -2,
	UIk7_1_NavigationWindowsNativeItemProgressBar = -3,
	
	UIk7_1_NavigationWindowsNativeItemSlider = -4,
	UIk7_1_NavigationWindowsNativeItemSwitch = -5,
	UIk7_1_NavigationWindowsNativeItemMultiButton = -6,
	UIk7_1_NavigationWindowsNativeItemSegmented = -7,
	
	UIk7_1_NavigationWindowsNativeItemTextView = -8,
	UIk7_1_NavigationWindowsNativeItemTextField = -9,
	UIk7_1_NavigationWindowsNativeItemSearchBar = -10,
	
	UIk7_1_NavigationWindowsNativeItemPicker = -11,
	UIk7_1_NavigationWindowsNativeItemDatePicker = -12,
	
	UIk7_1_NavigationWindowsNativeItemInfoLight = -13,
	UIk7_1_NavigationWindowsNativeItemInfoDark = -14,
	
	UIk7_1_NavigationWindowsNativeItemDisclosure = -15,
	
	UIk7_1_NavigationWindowsNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k7_1_NavigationWindows instances of
