...
/**
 Base class for all k7_1_NavigationWindows views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k7_1_NavigationWindows view hierarchy (such as wrapped iOS UIViews) was touched.
