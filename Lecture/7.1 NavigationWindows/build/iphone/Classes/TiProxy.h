...
//Rare exceptions to indicate a bug in the _k7_1_navigationwindows code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k7_1_NavigationWindows proxies.
 */
