...
@interface k7_1_NavigationWindowsObject : KrollCoverageObject {
#else
@interface k7_1_NavigationWindowsObject : KrollObject {
#endif
@private
...
extern NSString * k7_1_NavigationWindows$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k7_1_NavigationWindowsObject *_k7_1_navigationwindows;
    KrollObject* console;
	BOOL shutdown;
