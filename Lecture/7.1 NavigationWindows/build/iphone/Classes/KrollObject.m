...
//@interface k7_1_NavigationWindowsObject : NSObject
//@end

@interface k7_1_NavigationWindowsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k7_1_NavigationWindowsObject class]])
		{
			for (NSString *key in [[(k7_1_NavigationWindowsObject*)o modules] allKeys])
			{
