 ...
 * to send analytic data that can be viewed on the k7_1_NavigationWindows Dashboard.
 *
 * For information on getting started with k7_1_NavigationWindows Platform Services,
