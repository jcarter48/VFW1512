...
@interface k4_2_Layout_ModesObject : KrollCoverageObject {
#else
@interface k4_2_Layout_ModesObject : KrollObject {
#endif
@private
...
extern NSString * k4_2_Layout_Modes$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k4_2_Layout_ModesObject *_k4_2_layout_modes;
    KrollObject* console;
	BOOL shutdown;
