 ...
 * to send analytic data that can be viewed on the k4_2_Layout_Modes Dashboard.
 *
 * For information on getting started with k4_2_Layout_Modes Platform Services,
