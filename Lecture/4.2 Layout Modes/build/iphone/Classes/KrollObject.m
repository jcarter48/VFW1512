...
//@interface k4_2_Layout_ModesObject : NSObject
//@end

@interface k4_2_Layout_ModesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k4_2_Layout_ModesObject class]])
		{
			for (NSString *key in [[(k4_2_Layout_ModesObject*)o modules] allKeys])
			{
