...
/**
 Base class for all k4_2_Layout_Modes views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k4_2_Layout_Modes view hierarchy (such as wrapped iOS UIViews) was touched.
