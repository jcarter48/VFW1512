...
//Rare exceptions to indicate a bug in the _k4_2_layout_modes code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k4_2_Layout_Modes proxies.
 */
