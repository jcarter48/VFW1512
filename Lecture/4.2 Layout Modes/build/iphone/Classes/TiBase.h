...
// in simulator we redefine to format for k4_2_Layout_Modes Developer console
...
{\
	NSString * exceptionName = [@"org.k4_2_layout_modes." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k4_2_layout_modes";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk4_2_Layout_ModesNativeItemNone = -1, 
	UIk4_2_Layout_ModesNativeItemSpinner = -2,
	UIk4_2_Layout_ModesNativeItemProgressBar = -3,
	
	UIk4_2_Layout_ModesNativeItemSlider = -4,
	UIk4_2_Layout_ModesNativeItemSwitch = -5,
	UIk4_2_Layout_ModesNativeItemMultiButton = -6,
	UIk4_2_Layout_ModesNativeItemSegmented = -7,
	
	UIk4_2_Layout_ModesNativeItemTextView = -8,
	UIk4_2_Layout_ModesNativeItemTextField = -9,
	UIk4_2_Layout_ModesNativeItemSearchBar = -10,
	
	UIk4_2_Layout_ModesNativeItemPicker = -11,
	UIk4_2_Layout_ModesNativeItemDatePicker = -12,
	
	UIk4_2_Layout_ModesNativeItemInfoLight = -13,
	UIk4_2_Layout_ModesNativeItemInfoDark = -14,
	
	UIk4_2_Layout_ModesNativeItemDisclosure = -15,
	
	UIk4_2_Layout_ModesNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k4_2_Layout_Modes instances of
