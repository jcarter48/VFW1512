...
@interface k7_4_Code_RefactoringObject : KrollCoverageObject {
#else
@interface k7_4_Code_RefactoringObject : KrollObject {
#endif
@private
...
extern NSString * k7_4_Code_Refactoring$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k7_4_Code_RefactoringObject *_k7_4_code_refactoring;
    KrollObject* console;
	BOOL shutdown;
