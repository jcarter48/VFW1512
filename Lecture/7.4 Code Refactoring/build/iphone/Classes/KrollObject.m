...
//@interface k7_4_Code_RefactoringObject : NSObject
//@end

@interface k7_4_Code_RefactoringObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k7_4_Code_RefactoringObject class]])
		{
			for (NSString *key in [[(k7_4_Code_RefactoringObject*)o modules] allKeys])
			{
