...
/**
 Base class for all k7_4_Code_Refactoring views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k7_4_Code_Refactoring view hierarchy (such as wrapped iOS UIViews) was touched.
