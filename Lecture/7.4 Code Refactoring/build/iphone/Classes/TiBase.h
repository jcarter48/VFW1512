...
// in simulator we redefine to format for k7_4_Code_Refactoring Developer console
...
{\
	NSString * exceptionName = [@"org.k7_4_code_refactoring." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k7_4_code_refactoring";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk7_4_Code_RefactoringNativeItemNone = -1, 
	UIk7_4_Code_RefactoringNativeItemSpinner = -2,
	UIk7_4_Code_RefactoringNativeItemProgressBar = -3,
	
	UIk7_4_Code_RefactoringNativeItemSlider = -4,
	UIk7_4_Code_RefactoringNativeItemSwitch = -5,
	UIk7_4_Code_RefactoringNativeItemMultiButton = -6,
	UIk7_4_Code_RefactoringNativeItemSegmented = -7,
	
	UIk7_4_Code_RefactoringNativeItemTextView = -8,
	UIk7_4_Code_RefactoringNativeItemTextField = -9,
	UIk7_4_Code_RefactoringNativeItemSearchBar = -10,
	
	UIk7_4_Code_RefactoringNativeItemPicker = -11,
	UIk7_4_Code_RefactoringNativeItemDatePicker = -12,
	
	UIk7_4_Code_RefactoringNativeItemInfoLight = -13,
	UIk7_4_Code_RefactoringNativeItemInfoDark = -14,
	
	UIk7_4_Code_RefactoringNativeItemDisclosure = -15,
	
	UIk7_4_Code_RefactoringNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k7_4_Code_Refactoring instances of
