 ...
 * to send analytic data that can be viewed on the k7_4_Code_Refactoring Dashboard.
 *
 * For information on getting started with k7_4_Code_Refactoring Platform Services,
