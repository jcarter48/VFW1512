...
/**
 The base class for all k7_4_Code_Refactoring modules
 */
...
/**
 k7_4_Code_Refactoring Platform calls this method on startup.
 */
-(void)startup;

/**
 k7_4_Code_Refactoring Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 k7_4_Code_Refactoring Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 k7_4_Code_Refactoring Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 k7_4_Code_Refactoring Platform calls this method on resume.
 @param sender The sender of the event.
 */
