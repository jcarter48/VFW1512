...
//Rare exceptions to indicate a bug in the _k7_4_code_refactoring code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k7_4_Code_Refactoring proxies.
 */
