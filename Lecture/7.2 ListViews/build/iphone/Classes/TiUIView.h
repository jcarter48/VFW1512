...
/**
 Base class for all k7_2_ListViews views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k7_2_ListViews view hierarchy (such as wrapped iOS UIViews) was touched.
