...
//Rare exceptions to indicate a bug in the _k7_2_listviews code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k7_2_ListViews proxies.
 */
