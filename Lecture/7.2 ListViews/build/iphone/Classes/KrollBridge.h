...
@interface k7_2_ListViewsObject : KrollCoverageObject {
#else
@interface k7_2_ListViewsObject : KrollObject {
#endif
@private
...
extern NSString * k7_2_ListViews$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k7_2_ListViewsObject *_k7_2_listviews;
    KrollObject* console;
	BOOL shutdown;
