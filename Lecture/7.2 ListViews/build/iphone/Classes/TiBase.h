...
// in simulator we redefine to format for k7_2_ListViews Developer console
...
{\
	NSString * exceptionName = [@"org.k7_2_listviews." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k7_2_listviews";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk7_2_ListViewsNativeItemNone = -1, 
	UIk7_2_ListViewsNativeItemSpinner = -2,
	UIk7_2_ListViewsNativeItemProgressBar = -3,
	
	UIk7_2_ListViewsNativeItemSlider = -4,
	UIk7_2_ListViewsNativeItemSwitch = -5,
	UIk7_2_ListViewsNativeItemMultiButton = -6,
	UIk7_2_ListViewsNativeItemSegmented = -7,
	
	UIk7_2_ListViewsNativeItemTextView = -8,
	UIk7_2_ListViewsNativeItemTextField = -9,
	UIk7_2_ListViewsNativeItemSearchBar = -10,
	
	UIk7_2_ListViewsNativeItemPicker = -11,
	UIk7_2_ListViewsNativeItemDatePicker = -12,
	
	UIk7_2_ListViewsNativeItemInfoLight = -13,
	UIk7_2_ListViewsNativeItemInfoDark = -14,
	
	UIk7_2_ListViewsNativeItemDisclosure = -15,
	
	UIk7_2_ListViewsNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k7_2_ListViews instances of
