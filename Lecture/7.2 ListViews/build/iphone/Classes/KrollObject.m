...
//@interface k7_2_ListViewsObject : NSObject
//@end

@interface k7_2_ListViewsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k7_2_ListViewsObject class]])
		{
			for (NSString *key in [[(k7_2_ListViewsObject*)o modules] allKeys])
			{
