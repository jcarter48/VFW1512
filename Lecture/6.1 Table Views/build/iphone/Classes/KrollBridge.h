...
@interface k6_1_Table_ViewsObject : KrollCoverageObject {
#else
@interface k6_1_Table_ViewsObject : KrollObject {
#endif
@private
...
extern NSString * k6_1_Table_Views$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k6_1_Table_ViewsObject *_k6_1_table_views;
    KrollObject* console;
	BOOL shutdown;
