...
/**
 Base class for all k6_1_Table_Views views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k6_1_Table_Views view hierarchy (such as wrapped iOS UIViews) was touched.
