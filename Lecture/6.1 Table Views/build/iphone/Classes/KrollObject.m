...
//@interface k6_1_Table_ViewsObject : NSObject
//@end

@interface k6_1_Table_ViewsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k6_1_Table_ViewsObject class]])
		{
			for (NSString *key in [[(k6_1_Table_ViewsObject*)o modules] allKeys])
			{
