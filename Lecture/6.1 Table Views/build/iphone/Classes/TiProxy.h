...
//Rare exceptions to indicate a bug in the _k6_1_table_views code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k6_1_Table_Views proxies.
 */
