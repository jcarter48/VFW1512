...
// in simulator we redefine to format for k6_1_Table_Views Developer console
...
{\
	NSString * exceptionName = [@"org.k6_1_table_views." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k6_1_table_views";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk6_1_Table_ViewsNativeItemNone = -1, 
	UIk6_1_Table_ViewsNativeItemSpinner = -2,
	UIk6_1_Table_ViewsNativeItemProgressBar = -3,
	
	UIk6_1_Table_ViewsNativeItemSlider = -4,
	UIk6_1_Table_ViewsNativeItemSwitch = -5,
	UIk6_1_Table_ViewsNativeItemMultiButton = -6,
	UIk6_1_Table_ViewsNativeItemSegmented = -7,
	
	UIk6_1_Table_ViewsNativeItemTextView = -8,
	UIk6_1_Table_ViewsNativeItemTextField = -9,
	UIk6_1_Table_ViewsNativeItemSearchBar = -10,
	
	UIk6_1_Table_ViewsNativeItemPicker = -11,
	UIk6_1_Table_ViewsNativeItemDatePicker = -12,
	
	UIk6_1_Table_ViewsNativeItemInfoLight = -13,
	UIk6_1_Table_ViewsNativeItemInfoDark = -14,
	
	UIk6_1_Table_ViewsNativeItemDisclosure = -15,
	
	UIk6_1_Table_ViewsNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k6_1_Table_Views instances of
