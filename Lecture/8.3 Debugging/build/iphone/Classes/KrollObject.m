...
//@interface k8_3_DebuggingObject : NSObject
//@end

@interface k8_3_DebuggingObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k8_3_DebuggingObject class]])
		{
			for (NSString *key in [[(k8_3_DebuggingObject*)o modules] allKeys])
			{
