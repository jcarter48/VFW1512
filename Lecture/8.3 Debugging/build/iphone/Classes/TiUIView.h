...
/**
 Base class for all k8_3_Debugging views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k8_3_Debugging view hierarchy (such as wrapped iOS UIViews) was touched.
