...
// in simulator we redefine to format for k8_3_Debugging Developer console
...
{\
	NSString * exceptionName = [@"org.k8_3_debugging." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k8_3_debugging";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk8_3_DebuggingNativeItemNone = -1, 
	UIk8_3_DebuggingNativeItemSpinner = -2,
	UIk8_3_DebuggingNativeItemProgressBar = -3,
	
	UIk8_3_DebuggingNativeItemSlider = -4,
	UIk8_3_DebuggingNativeItemSwitch = -5,
	UIk8_3_DebuggingNativeItemMultiButton = -6,
	UIk8_3_DebuggingNativeItemSegmented = -7,
	
	UIk8_3_DebuggingNativeItemTextView = -8,
	UIk8_3_DebuggingNativeItemTextField = -9,
	UIk8_3_DebuggingNativeItemSearchBar = -10,
	
	UIk8_3_DebuggingNativeItemPicker = -11,
	UIk8_3_DebuggingNativeItemDatePicker = -12,
	
	UIk8_3_DebuggingNativeItemInfoLight = -13,
	UIk8_3_DebuggingNativeItemInfoDark = -14,
	
	UIk8_3_DebuggingNativeItemDisclosure = -15,
	
	UIk8_3_DebuggingNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k8_3_Debugging instances of
