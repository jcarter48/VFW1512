...
@interface k8_3_DebuggingObject : KrollCoverageObject {
#else
@interface k8_3_DebuggingObject : KrollObject {
#endif
@private
...
extern NSString * k8_3_Debugging$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k8_3_DebuggingObject *_k8_3_debugging;
    KrollObject* console;
	BOOL shutdown;
