...
//Rare exceptions to indicate a bug in the _k7_3_event_propagation code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k7_3_Event_Propagation proxies.
 */
