...
//@interface k7_3_Event_PropagationObject : NSObject
//@end

@interface k7_3_Event_PropagationObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k7_3_Event_PropagationObject class]])
		{
			for (NSString *key in [[(k7_3_Event_PropagationObject*)o modules] allKeys])
			{
