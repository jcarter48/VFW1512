...
// in simulator we redefine to format for k7_3_Event_Propagation Developer console
...
{\
	NSString * exceptionName = [@"org.k7_3_event_propagation." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k7_3_event_propagation";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk7_3_Event_PropagationNativeItemNone = -1, 
	UIk7_3_Event_PropagationNativeItemSpinner = -2,
	UIk7_3_Event_PropagationNativeItemProgressBar = -3,
	
	UIk7_3_Event_PropagationNativeItemSlider = -4,
	UIk7_3_Event_PropagationNativeItemSwitch = -5,
	UIk7_3_Event_PropagationNativeItemMultiButton = -6,
	UIk7_3_Event_PropagationNativeItemSegmented = -7,
	
	UIk7_3_Event_PropagationNativeItemTextView = -8,
	UIk7_3_Event_PropagationNativeItemTextField = -9,
	UIk7_3_Event_PropagationNativeItemSearchBar = -10,
	
	UIk7_3_Event_PropagationNativeItemPicker = -11,
	UIk7_3_Event_PropagationNativeItemDatePicker = -12,
	
	UIk7_3_Event_PropagationNativeItemInfoLight = -13,
	UIk7_3_Event_PropagationNativeItemInfoDark = -14,
	
	UIk7_3_Event_PropagationNativeItemDisclosure = -15,
	
	UIk7_3_Event_PropagationNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k7_3_Event_Propagation instances of
