...
@interface k7_3_Event_PropagationObject : KrollCoverageObject {
#else
@interface k7_3_Event_PropagationObject : KrollObject {
#endif
@private
...
extern NSString * k7_3_Event_Propagation$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k7_3_Event_PropagationObject *_k7_3_event_propagation;
    KrollObject* console;
	BOOL shutdown;
