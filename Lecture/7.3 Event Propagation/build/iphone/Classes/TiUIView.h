...
/**
 Base class for all k7_3_Event_Propagation views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k7_3_Event_Propagation view hierarchy (such as wrapped iOS UIViews) was touched.
