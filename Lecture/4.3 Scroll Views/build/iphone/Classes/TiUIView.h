...
/**
 Base class for all k4_3_Scroll_Views views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k4_3_Scroll_Views view hierarchy (such as wrapped iOS UIViews) was touched.
