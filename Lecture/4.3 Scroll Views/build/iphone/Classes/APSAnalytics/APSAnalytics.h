 ...
 * to send analytic data that can be viewed on the k4_3_Scroll_Views Dashboard.
 *
 * For information on getting started with k4_3_Scroll_Views Platform Services,
