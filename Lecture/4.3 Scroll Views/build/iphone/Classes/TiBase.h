...
// in simulator we redefine to format for k4_3_Scroll_Views Developer console
...
{\
	NSString * exceptionName = [@"org.k4_3_scroll_views." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k4_3_scroll_views";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk4_3_Scroll_ViewsNativeItemNone = -1, 
	UIk4_3_Scroll_ViewsNativeItemSpinner = -2,
	UIk4_3_Scroll_ViewsNativeItemProgressBar = -3,
	
	UIk4_3_Scroll_ViewsNativeItemSlider = -4,
	UIk4_3_Scroll_ViewsNativeItemSwitch = -5,
	UIk4_3_Scroll_ViewsNativeItemMultiButton = -6,
	UIk4_3_Scroll_ViewsNativeItemSegmented = -7,
	
	UIk4_3_Scroll_ViewsNativeItemTextView = -8,
	UIk4_3_Scroll_ViewsNativeItemTextField = -9,
	UIk4_3_Scroll_ViewsNativeItemSearchBar = -10,
	
	UIk4_3_Scroll_ViewsNativeItemPicker = -11,
	UIk4_3_Scroll_ViewsNativeItemDatePicker = -12,
	
	UIk4_3_Scroll_ViewsNativeItemInfoLight = -13,
	UIk4_3_Scroll_ViewsNativeItemInfoDark = -14,
	
	UIk4_3_Scroll_ViewsNativeItemDisclosure = -15,
	
	UIk4_3_Scroll_ViewsNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k4_3_Scroll_Views instances of
