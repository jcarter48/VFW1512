...
@interface k4_3_Scroll_ViewsObject : KrollCoverageObject {
#else
@interface k4_3_Scroll_ViewsObject : KrollObject {
#endif
@private
...
extern NSString * k4_3_Scroll_Views$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k4_3_Scroll_ViewsObject *_k4_3_scroll_views;
    KrollObject* console;
	BOOL shutdown;
