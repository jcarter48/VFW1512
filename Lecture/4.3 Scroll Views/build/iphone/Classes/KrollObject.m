...
//@interface k4_3_Scroll_ViewsObject : NSObject
//@end

@interface k4_3_Scroll_ViewsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k4_3_Scroll_ViewsObject class]])
		{
			for (NSString *key in [[(k4_3_Scroll_ViewsObject*)o modules] allKeys])
			{
