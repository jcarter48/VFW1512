 ...
 * to send analytic data that can be viewed on the k8_1_Interface_Demo Dashboard.
 *
 * For information on getting started with k8_1_Interface_Demo Platform Services,
