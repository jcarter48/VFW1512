...
/**
 Base class for all k8_1_Interface_Demo views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k8_1_Interface_Demo view hierarchy (such as wrapped iOS UIViews) was touched.
