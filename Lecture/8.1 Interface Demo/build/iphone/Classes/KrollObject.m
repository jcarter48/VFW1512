...
//@interface k8_1_Interface_DemoObject : NSObject
//@end

@interface k8_1_Interface_DemoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k8_1_Interface_DemoObject class]])
		{
			for (NSString *key in [[(k8_1_Interface_DemoObject*)o modules] allKeys])
			{
