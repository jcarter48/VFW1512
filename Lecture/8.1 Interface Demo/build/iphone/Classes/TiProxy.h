...
//Rare exceptions to indicate a bug in the _k8_1_interface_demo code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k8_1_Interface_Demo proxies.
 */
