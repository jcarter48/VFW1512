...
@interface k8_1_Interface_DemoObject : KrollCoverageObject {
#else
@interface k8_1_Interface_DemoObject : KrollObject {
#endif
@private
...
extern NSString * k8_1_Interface_Demo$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k8_1_Interface_DemoObject *_k8_1_interface_demo;
    KrollObject* console;
	BOOL shutdown;
