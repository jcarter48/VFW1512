...
// in simulator we redefine to format for k8_1_Interface_Demo Developer console
...
{\
	NSString * exceptionName = [@"org.k8_1_interface_demo." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k8_1_interface_demo";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk8_1_Interface_DemoNativeItemNone = -1, 
	UIk8_1_Interface_DemoNativeItemSpinner = -2,
	UIk8_1_Interface_DemoNativeItemProgressBar = -3,
	
	UIk8_1_Interface_DemoNativeItemSlider = -4,
	UIk8_1_Interface_DemoNativeItemSwitch = -5,
	UIk8_1_Interface_DemoNativeItemMultiButton = -6,
	UIk8_1_Interface_DemoNativeItemSegmented = -7,
	
	UIk8_1_Interface_DemoNativeItemTextView = -8,
	UIk8_1_Interface_DemoNativeItemTextField = -9,
	UIk8_1_Interface_DemoNativeItemSearchBar = -10,
	
	UIk8_1_Interface_DemoNativeItemPicker = -11,
	UIk8_1_Interface_DemoNativeItemDatePicker = -12,
	
	UIk8_1_Interface_DemoNativeItemInfoLight = -13,
	UIk8_1_Interface_DemoNativeItemInfoDark = -14,
	
	UIk8_1_Interface_DemoNativeItemDisclosure = -15,
	
	UIk8_1_Interface_DemoNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k8_1_Interface_Demo instances of
