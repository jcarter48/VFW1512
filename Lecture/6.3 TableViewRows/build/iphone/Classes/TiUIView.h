...
/**
 Base class for all k6_3_TableViewRows views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k6_3_TableViewRows view hierarchy (such as wrapped iOS UIViews) was touched.
