 ...
 * to send analytic data that can be viewed on the k6_3_TableViewRows Dashboard.
 *
 * For information on getting started with k6_3_TableViewRows Platform Services,
