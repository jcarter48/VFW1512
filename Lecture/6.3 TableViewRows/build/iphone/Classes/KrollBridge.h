...
@interface k6_3_TableViewRowsObject : KrollCoverageObject {
#else
@interface k6_3_TableViewRowsObject : KrollObject {
#endif
@private
...
extern NSString * k6_3_TableViewRows$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k6_3_TableViewRowsObject *_k6_3_tableviewrows;
    KrollObject* console;
	BOOL shutdown;
