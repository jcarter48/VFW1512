...
// in simulator we redefine to format for k6_3_TableViewRows Developer console
...
{\
	NSString * exceptionName = [@"org.k6_3_tableviewrows." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k6_3_tableviewrows";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk6_3_TableViewRowsNativeItemNone = -1, 
	UIk6_3_TableViewRowsNativeItemSpinner = -2,
	UIk6_3_TableViewRowsNativeItemProgressBar = -3,
	
	UIk6_3_TableViewRowsNativeItemSlider = -4,
	UIk6_3_TableViewRowsNativeItemSwitch = -5,
	UIk6_3_TableViewRowsNativeItemMultiButton = -6,
	UIk6_3_TableViewRowsNativeItemSegmented = -7,
	
	UIk6_3_TableViewRowsNativeItemTextView = -8,
	UIk6_3_TableViewRowsNativeItemTextField = -9,
	UIk6_3_TableViewRowsNativeItemSearchBar = -10,
	
	UIk6_3_TableViewRowsNativeItemPicker = -11,
	UIk6_3_TableViewRowsNativeItemDatePicker = -12,
	
	UIk6_3_TableViewRowsNativeItemInfoLight = -13,
	UIk6_3_TableViewRowsNativeItemInfoDark = -14,
	
	UIk6_3_TableViewRowsNativeItemDisclosure = -15,
	
	UIk6_3_TableViewRowsNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k6_3_TableViewRows instances of
