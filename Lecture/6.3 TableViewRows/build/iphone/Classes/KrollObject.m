...
//@interface k6_3_TableViewRowsObject : NSObject
//@end

@interface k6_3_TableViewRowsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k6_3_TableViewRowsObject class]])
		{
			for (NSString *key in [[(k6_3_TableViewRowsObject*)o modules] allKeys])
			{
