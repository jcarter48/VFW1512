...
MAKE_SYSTEM_PROP(ACTIVITY,UIk3_2_ExportsNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIk3_2_ExportsNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIk3_2_ExportsNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIk3_2_ExportsNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIk3_2_ExportsNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIk3_2_ExportsNativeItemContactAdd);
