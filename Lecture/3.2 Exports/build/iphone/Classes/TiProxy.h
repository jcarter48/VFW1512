...
//Rare exceptions to indicate a bug in the _k3_2_exports code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k3_2_Exports proxies.
 */
