...
/**
 The base class for all k3_2_Exports modules
 */
...
/**
 k3_2_Exports Platform calls this method on startup.
 */
-(void)startup;

/**
 k3_2_Exports Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 k3_2_Exports Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 k3_2_Exports Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 k3_2_Exports Platform calls this method on resume.
 @param sender The sender of the event.
 */
