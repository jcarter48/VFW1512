...
@interface k3_2_ExportsObject : KrollCoverageObject {
#else
@interface k3_2_ExportsObject : KrollObject {
#endif
@private
...
extern NSString * k3_2_Exports$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k3_2_ExportsObject *_k3_2_exports;
    KrollObject* console;
	BOOL shutdown;
