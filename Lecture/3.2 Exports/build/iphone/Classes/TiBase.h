...
// in simulator we redefine to format for k3_2_Exports Developer console
...
{\
	NSString * exceptionName = [@"org.k3_2_exports." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k3_2_exports";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk3_2_ExportsNativeItemNone = -1, 
	UIk3_2_ExportsNativeItemSpinner = -2,
	UIk3_2_ExportsNativeItemProgressBar = -3,
	
	UIk3_2_ExportsNativeItemSlider = -4,
	UIk3_2_ExportsNativeItemSwitch = -5,
	UIk3_2_ExportsNativeItemMultiButton = -6,
	UIk3_2_ExportsNativeItemSegmented = -7,
	
	UIk3_2_ExportsNativeItemTextView = -8,
	UIk3_2_ExportsNativeItemTextField = -9,
	UIk3_2_ExportsNativeItemSearchBar = -10,
	
	UIk3_2_ExportsNativeItemPicker = -11,
	UIk3_2_ExportsNativeItemDatePicker = -12,
	
	UIk3_2_ExportsNativeItemInfoLight = -13,
	UIk3_2_ExportsNativeItemInfoDark = -14,
	
	UIk3_2_ExportsNativeItemDisclosure = -15,
	
	UIk3_2_ExportsNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k3_2_Exports instances of
