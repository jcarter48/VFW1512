...
//@interface k3_2_ExportsObject : NSObject
//@end

@interface k3_2_ExportsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k3_2_ExportsObject class]])
		{
			for (NSString *key in [[(k3_2_ExportsObject*)o modules] allKeys])
			{
