...
//@interface k3_1_Event_ListenersObject : NSObject
//@end

@interface k3_1_Event_ListenersObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k3_1_Event_ListenersObject class]])
		{
			for (NSString *key in [[(k3_1_Event_ListenersObject*)o modules] allKeys])
			{
