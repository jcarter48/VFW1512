...
@interface k3_1_Event_ListenersObject : KrollCoverageObject {
#else
@interface k3_1_Event_ListenersObject : KrollObject {
#endif
@private
...
extern NSString * k3_1_Event_Listeners$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k3_1_Event_ListenersObject *_k3_1_event_listeners;
    KrollObject* console;
	BOOL shutdown;
