...
/**
 The base class for all k3_1_Event_Listeners modules
 */
...
/**
 k3_1_Event_Listeners Platform calls this method on startup.
 */
-(void)startup;

/**
 k3_1_Event_Listeners Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 k3_1_Event_Listeners Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 k3_1_Event_Listeners Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 k3_1_Event_Listeners Platform calls this method on resume.
 @param sender The sender of the event.
 */
