...
// in simulator we redefine to format for k3_1_Event_Listeners Developer console
...
{\
	NSString * exceptionName = [@"org.k3_1_event_listeners." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k3_1_event_listeners";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk3_1_Event_ListenersNativeItemNone = -1, 
	UIk3_1_Event_ListenersNativeItemSpinner = -2,
	UIk3_1_Event_ListenersNativeItemProgressBar = -3,
	
	UIk3_1_Event_ListenersNativeItemSlider = -4,
	UIk3_1_Event_ListenersNativeItemSwitch = -5,
	UIk3_1_Event_ListenersNativeItemMultiButton = -6,
	UIk3_1_Event_ListenersNativeItemSegmented = -7,
	
	UIk3_1_Event_ListenersNativeItemTextView = -8,
	UIk3_1_Event_ListenersNativeItemTextField = -9,
	UIk3_1_Event_ListenersNativeItemSearchBar = -10,
	
	UIk3_1_Event_ListenersNativeItemPicker = -11,
	UIk3_1_Event_ListenersNativeItemDatePicker = -12,
	
	UIk3_1_Event_ListenersNativeItemInfoLight = -13,
	UIk3_1_Event_ListenersNativeItemInfoDark = -14,
	
	UIk3_1_Event_ListenersNativeItemDisclosure = -15,
	
	UIk3_1_Event_ListenersNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k3_1_Event_Listeners instances of
