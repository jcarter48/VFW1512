...
/**
 Base class for all k3_1_Event_Listeners views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k3_1_Event_Listeners view hierarchy (such as wrapped iOS UIViews) was touched.
