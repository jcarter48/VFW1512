...
//Rare exceptions to indicate a bug in the _k3_1_event_listeners code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k3_1_Event_Listeners proxies.
 */
