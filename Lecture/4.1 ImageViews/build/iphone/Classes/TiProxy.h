...
//Rare exceptions to indicate a bug in the _k4_1_imageviews code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k4_1_ImageViews proxies.
 */
