...
//@interface k4_1_ImageViewsObject : NSObject
//@end

@interface k4_1_ImageViewsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k4_1_ImageViewsObject class]])
		{
			for (NSString *key in [[(k4_1_ImageViewsObject*)o modules] allKeys])
			{
