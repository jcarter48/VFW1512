...
@interface k4_1_ImageViewsObject : KrollCoverageObject {
#else
@interface k4_1_ImageViewsObject : KrollObject {
#endif
@private
...
extern NSString * k4_1_ImageViews$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k4_1_ImageViewsObject *_k4_1_imageviews;
    KrollObject* console;
	BOOL shutdown;
