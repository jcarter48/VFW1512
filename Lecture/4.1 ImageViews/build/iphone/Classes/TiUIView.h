...
/**
 Base class for all k4_1_ImageViews views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k4_1_ImageViews view hierarchy (such as wrapped iOS UIViews) was touched.
