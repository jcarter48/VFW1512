...
// in simulator we redefine to format for k4_1_ImageViews Developer console
...
{\
	NSString * exceptionName = [@"org.k4_1_imageviews." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k4_1_imageviews";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk4_1_ImageViewsNativeItemNone = -1, 
	UIk4_1_ImageViewsNativeItemSpinner = -2,
	UIk4_1_ImageViewsNativeItemProgressBar = -3,
	
	UIk4_1_ImageViewsNativeItemSlider = -4,
	UIk4_1_ImageViewsNativeItemSwitch = -5,
	UIk4_1_ImageViewsNativeItemMultiButton = -6,
	UIk4_1_ImageViewsNativeItemSegmented = -7,
	
	UIk4_1_ImageViewsNativeItemTextView = -8,
	UIk4_1_ImageViewsNativeItemTextField = -9,
	UIk4_1_ImageViewsNativeItemSearchBar = -10,
	
	UIk4_1_ImageViewsNativeItemPicker = -11,
	UIk4_1_ImageViewsNativeItemDatePicker = -12,
	
	UIk4_1_ImageViewsNativeItemInfoLight = -13,
	UIk4_1_ImageViewsNativeItemInfoDark = -14,
	
	UIk4_1_ImageViewsNativeItemDisclosure = -15,
	
	UIk4_1_ImageViewsNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k4_1_ImageViews instances of
