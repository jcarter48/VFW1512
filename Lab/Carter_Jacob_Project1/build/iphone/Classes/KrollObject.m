...
//@interface Carter_Jacob_Project_2Object : NSObject
//@end

@interface Carter_Jacob_Project_2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Carter_Jacob_Project_2Object class]])
		{
			for (NSString *key in [[(Carter_Jacob_Project_2Object*)o modules] allKeys])
			{
