...
// in simulator we redefine to format for Carter_Jacob_Project_2 Developer console
...
{\
	NSString * exceptionName = [@"org.carter_jacob_project_2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.carter_jacob_project_2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICarter_Jacob_Project_2NativeItemNone = -1, 
	UICarter_Jacob_Project_2NativeItemSpinner = -2,
	UICarter_Jacob_Project_2NativeItemProgressBar = -3,
	
	UICarter_Jacob_Project_2NativeItemSlider = -4,
	UICarter_Jacob_Project_2NativeItemSwitch = -5,
	UICarter_Jacob_Project_2NativeItemMultiButton = -6,
	UICarter_Jacob_Project_2NativeItemSegmented = -7,
	
	UICarter_Jacob_Project_2NativeItemTextView = -8,
	UICarter_Jacob_Project_2NativeItemTextField = -9,
	UICarter_Jacob_Project_2NativeItemSearchBar = -10,
	
	UICarter_Jacob_Project_2NativeItemPicker = -11,
	UICarter_Jacob_Project_2NativeItemDatePicker = -12,
	
	UICarter_Jacob_Project_2NativeItemInfoLight = -13,
	UICarter_Jacob_Project_2NativeItemInfoDark = -14,
	
	UICarter_Jacob_Project_2NativeItemDisclosure = -15,
	
	UICarter_Jacob_Project_2NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Carter_Jacob_Project_2 instances of
