...
@interface Carter_Jacob_Project_2Object : KrollCoverageObject {
#else
@interface Carter_Jacob_Project_2Object : KrollObject {
#endif
@private
...
extern NSString * Carter_Jacob_Project_2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Carter_Jacob_Project_2Object *_carter_jacob_project_2;
    KrollObject* console;
	BOOL shutdown;
