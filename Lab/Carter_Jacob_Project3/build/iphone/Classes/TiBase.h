...
// in simulator we redefine to format for Carter_Jacob_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.carter_jacob_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.carter_jacob_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICarter_Jacob_Project3NativeItemNone = -1, 
	UICarter_Jacob_Project3NativeItemSpinner = -2,
	UICarter_Jacob_Project3NativeItemProgressBar = -3,
	
	UICarter_Jacob_Project3NativeItemSlider = -4,
	UICarter_Jacob_Project3NativeItemSwitch = -5,
	UICarter_Jacob_Project3NativeItemMultiButton = -6,
	UICarter_Jacob_Project3NativeItemSegmented = -7,
	
	UICarter_Jacob_Project3NativeItemTextView = -8,
	UICarter_Jacob_Project3NativeItemTextField = -9,
	UICarter_Jacob_Project3NativeItemSearchBar = -10,
	
	UICarter_Jacob_Project3NativeItemPicker = -11,
	UICarter_Jacob_Project3NativeItemDatePicker = -12,
	
	UICarter_Jacob_Project3NativeItemInfoLight = -13,
	UICarter_Jacob_Project3NativeItemInfoDark = -14,
	
	UICarter_Jacob_Project3NativeItemDisclosure = -15,
	
	UICarter_Jacob_Project3NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Carter_Jacob_Project3 instances of
