...
@interface Carter_Jacob_Project3Object : KrollCoverageObject {
#else
@interface Carter_Jacob_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Carter_Jacob_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Carter_Jacob_Project3Object *_carter_jacob_project3;
    KrollObject* console;
	BOOL shutdown;
