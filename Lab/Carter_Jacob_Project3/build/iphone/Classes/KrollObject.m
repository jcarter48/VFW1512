...
//@interface Carter_Jacob_Project3Object : NSObject
//@end

@interface Carter_Jacob_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Carter_Jacob_Project3Object class]])
		{
			for (NSString *key in [[(Carter_Jacob_Project3Object*)o modules] allKeys])
			{
