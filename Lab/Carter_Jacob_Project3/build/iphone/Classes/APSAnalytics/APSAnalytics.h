 ...
 * to send analytic data that can be viewed on the Carter_Jacob_Project3 Dashboard.
 *
 * For information on getting started with Carter_Jacob_Project3 Platform Services,
