...
//Rare exceptions to indicate a bug in the _carter_jacob_project3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Carter_Jacob_Project3 proxies.
 */
