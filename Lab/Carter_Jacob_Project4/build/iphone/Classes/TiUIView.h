...
/**
 Base class for all Carter_Jacob_Project4 views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the Carter_Jacob_Project4 view hierarchy (such as wrapped iOS UIViews) was touched.
