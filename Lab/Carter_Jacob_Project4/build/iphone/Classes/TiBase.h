...
// in simulator we redefine to format for Carter_Jacob_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.carter_jacob_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.carter_jacob_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICarter_Jacob_Project4NativeItemNone = -1, 
	UICarter_Jacob_Project4NativeItemSpinner = -2,
	UICarter_Jacob_Project4NativeItemProgressBar = -3,
	
	UICarter_Jacob_Project4NativeItemSlider = -4,
	UICarter_Jacob_Project4NativeItemSwitch = -5,
	UICarter_Jacob_Project4NativeItemMultiButton = -6,
	UICarter_Jacob_Project4NativeItemSegmented = -7,
	
	UICarter_Jacob_Project4NativeItemTextView = -8,
	UICarter_Jacob_Project4NativeItemTextField = -9,
	UICarter_Jacob_Project4NativeItemSearchBar = -10,
	
	UICarter_Jacob_Project4NativeItemPicker = -11,
	UICarter_Jacob_Project4NativeItemDatePicker = -12,
	
	UICarter_Jacob_Project4NativeItemInfoLight = -13,
	UICarter_Jacob_Project4NativeItemInfoDark = -14,
	
	UICarter_Jacob_Project4NativeItemDisclosure = -15,
	
	UICarter_Jacob_Project4NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Carter_Jacob_Project4 instances of
