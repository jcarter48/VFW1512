...
/**
 The base class for all Carter_Jacob_Project4 modules
 */
...
/**
 Carter_Jacob_Project4 Platform calls this method on startup.
 */
-(void)startup;

/**
 Carter_Jacob_Project4 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Carter_Jacob_Project4 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Carter_Jacob_Project4 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Carter_Jacob_Project4 Platform calls this method on resume.
 @param sender The sender of the event.
 */
