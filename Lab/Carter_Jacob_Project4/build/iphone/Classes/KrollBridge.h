...
@interface Carter_Jacob_Project4Object : KrollCoverageObject {
#else
@interface Carter_Jacob_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Carter_Jacob_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Carter_Jacob_Project4Object *_carter_jacob_project4;
    KrollObject* console;
	BOOL shutdown;
