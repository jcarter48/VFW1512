 ...
 * to send analytic data that can be viewed on the Carter_Jacob_Project4 Dashboard.
 *
 * For information on getting started with Carter_Jacob_Project4 Platform Services,
