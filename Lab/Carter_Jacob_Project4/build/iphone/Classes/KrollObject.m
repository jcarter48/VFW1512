...
//@interface Carter_Jacob_Project4Object : NSObject
//@end

@interface Carter_Jacob_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Carter_Jacob_Project4Object class]])
		{
			for (NSString *key in [[(Carter_Jacob_Project4Object*)o modules] allKeys])
			{
